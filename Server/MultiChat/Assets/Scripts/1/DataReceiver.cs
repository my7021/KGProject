...
public class DataReceiver
{
    ...
    public class PacketData : PacketHeader
    {
        ...
        public PacketData(short nPacketId, short nSize, byte[] kData) : base(nPacketId, nSize)
        {
    ...
    public event EventHandler<PacketData> OnReceiveHandeler = null;
    ...
    void DoIt(Socket doSocket)
    {
        ...
        var kPacketData = new PacketData(nPacketId, nSize, packet);

        if (OnReceiveHandeler != null)
        {
            OnReceiveHandeler(this, kPacketData);
        }
    }
}
